...
with open('Middle_east.json', encoding='utf8') as file:  
    data_middle_east = json.load(file)
...
# data_1 = data[1]
# print(data_1)
# data_1 = data + data_palestine
# print(data_1)

with open('Israel_Middle_East_2002.csv', 'w', encoding='utf8') as file:
    file.write('Country,Fatalities,Year,\n') 
    for incidence in data:
        file.write(f'{incidence["country"]},{incidence["best"]},{incidence["year"]} \n')
    for incidence in data_middle_east:
        file.write(f'{incidence["country"]},{incidence["best"]},{incidence["year"]} \n')
